...
typedef SWIFT_ENUM_NAMED(NSInteger, PhoneNumberFormat, "PhoneNumberFormat", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, PhoneNumberType, "PhoneNumberType", closed) {
